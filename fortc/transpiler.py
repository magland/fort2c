"""
fortc.transpiler - a deterministic Fortran -> C transpiler.
...
def generate_c(path, basename=None, only=None,
    ...
    out.append(' *')
    out.append(' * Generated by fortc (fparser2 front end). Do not edit by hand.')
    out.append(' */')
    out.append('')
    if needs_alloc:
...
def generate_h(path, basename=None, only=None,
    ...
    out = []
    out.append(f'/* {basename}.h - generated by fortc */')
